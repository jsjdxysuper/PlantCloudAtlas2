...
import com.kedong.newenergyapp.bussiness.WelcomeActivity;
import com.kedong.utils.ApkUtil;

public class MyReceiver extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {
        boolean state = ApkUtil.isProessRunning(context, "com.kedong.newenergyapp");
        //判断app进程是否存活
        if(state){
...
//            context.
            ...
            Intent launchIntent = context.getPackageManager().
                    getLaunchIntentForPackage("com.kedong.newenergyapp");
            ...
            launchIntent.putExtra("msg", args);
